...
export const GetAllUserInitiate = (token) => {
  return async function (dispatch) {
    ...
    await axios
      ...
      .then((user) => {
        console.log(user,"asdasdhgsafjagsflsfghjasrkhgulradshvdkjbvdhjkshbvjkdbhshkdjbhharhshb")
        dispatch(GetAllUserSuccess(user.data));
      })
      .catch((error) => {
        console.log(error,"asdasidbhwuiehfiseihafuasjhgfausrjkhgsrkjghasrkjghsrhgasfkj")
